...
export function Sidebar({
  ...
  return (
    <>
      <aside
        className={[
          "fixed inset-y-0 left-0 z-40 flex w-[min(100vw-2.5rem,17rem)] flex-col border-r border-[#333] bg-black p-4 pt-[max(1rem,env(safe-area-inset-top))] transition-transform duration-200 ease-out lg:static lg:z-auto lg:w-64 lg:shrink-0 lg:translate-x-0 lg:min-h-screen",
